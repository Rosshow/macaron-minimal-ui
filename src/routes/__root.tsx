...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "摇人吧 · 工单协同" },
      { name: "description", content: "摇人吧移动工作台：智能提单、工单协同与项目看板。" },
      { name: "author", content: "摇人吧" },
      { property: "og:title", content: "摇人吧 · 工单协同" },
      { property: "og:description", content: "摇人吧移动工作台：智能提单、工单协同与项目看板。" },
