    ...
    <PageShell title="工单详情" back>
      <section className="surface-card p-4">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <button className="rounded bg-secondary px-3 py-1.5 text-[11.5px] font-medium text-foreground">
              暂停任务
            </button>
            <button className="rounded bg-primary px-3 py-1.5 text-[11.5px] font-medium text-primary-foreground">
              处理完成
            </button>
          </div>
        </div>
      ...
      <section className="surface-card mt-3 p-4">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2">
          ...
          <button className="flex shrink-0 items-center gap-1.5 rounded bg-primary px-3 py-1.5 text-[12px] font-medium text-primary-foreground">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {["修改工单", "退回工单", "重新指派", "升级上报"].map((label) => (
          <button
            key={label}
            className="rounded bg-blue-3 px-3.5 py-1.5 text-[12px] font-medium text-white shadow-sm transition-colors hover:bg-blue-2"
          >
            {label}
          </button>
        ))}
